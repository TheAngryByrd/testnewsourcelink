...
[<assembly: AssemblyTitleAttribute("testnewsourcelink.Tests")>]
[<assembly: AssemblyProductAttribute("testnewsourcelink")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "testnewsourcelink.Tests"
    let [<Literal>] AssemblyProduct = "testnewsourcelink"
